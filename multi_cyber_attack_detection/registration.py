...
frame = tk.LabelFrame(window, text="", width=600, height=570, bd=5, font=('times', 14, ' bold '),bg="#2ad5b8")
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=50, y=130)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=55,bg="#a45b69",fg="black")
lbl.place(x=0, y=0)
...
btn = tk.Button(frame, text="Register", bg="black",font=("",20),fg="white", width=9, height=1, command=insert)
